...
export default function PrivacyStatement() {
  return (
    <div className="flex flex-col gap-3">
      ...
      <Text>
        Depending on the service, we process the following information that you
        provide to Virtual Finland:
      </Text>
      ...
      <Text>
        We process your personal data for one or more of the purposes described
        below.
      </Text>
      <CustomHeading variant="h4">
      ...
      <Text>
        We will only disclose information to parties outside Virtual Finland in
      ...
      <div className="flex flex-col gap-4">
        <Text>
          The controller of your personal data is Virtual Finland, located at
          Address 5, 00240 Helsinki.
        </Text>
        <Text>
        ...
        <Text>
          ...
          creation, we encourage you to delete your profile data. Nothing will
          be stored about you after this process.
        </Text>
      </div>
    </div>
  );
